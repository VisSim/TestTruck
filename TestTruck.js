...
window.addEventListener("load", (e) => {
  ...
  createApp({
    ...
    sceneURL: params.load || "__URL__TestTruck.glb".replace("__URL__", ""),
    logicURL:
      params.logic || "__LOGIC__visual_logic.js".replace("__LOGIC__", ""),
  });
});
...
async function createApp({
  ...
  if (v3d.AppUtils.isXML(logicURL)) {
    ...
    PL = await new v3d.PuzzlesLoader().loadEditorWithLogic(
      PUZZLES_DIR,
      logicURLJS
    );
    PE = v3d.PE;
